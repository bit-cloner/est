...
curl -LO https://github.com/bit-cloner/est/releases/latest/download/$VERSION/est-$VERSION-darwin-amd64.tar.gz
...
curl -LO https://github.com/bit-cloner/est/releases/latest/download/$VERSION/est-$VERSION-darwin-arm64.tar.gz
...
curl -LO https://github.com/bit-cloner/est/releases/latest/download/$VERSION/est-$VERSION-linux-amd64.tar.gz
...
curl -LO https://github.com/bit-cloner/est/releases/latest/download/$VERSION/est-V$ERSION-linux-arm64.tar.gz
...
Invoke-WebRequest -Uri https://github.com/bit-cloner/est/releases/latest/download/$VERSION/est-$VERSION-windows-amd64.zip -OutFile est.zip
...
Invoke-WebRequest -Uri https://github.com/bit-cloner/est/releases/latest/download/$VERSION/est-$VERSION-windows-386.zip -OutFile est.zip
